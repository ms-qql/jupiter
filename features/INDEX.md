...
| ID | Feature | Prio | Status | Abhängigkeiten | Spec |
|----|---------|------|--------|----------------|------|
| PROJ-9 | Smart Launcher (mitdenkender Session-Start) | P1 | In Review | PROJ-3, PROJ-1 | [Spec](PROJ-9-smart-launcher.md) |
| PROJ-10 | Trust-Policy (abgestuft, konfigurierbar) + Phasen-Gate | P1 | Approved | PROJ-4, PROJ-6, PROJ-8 | [Spec](PROJ-10-trust-policy.md) |
| PROJ-11 | Fileexplorer + Drag-and-Drop | P1 | Deployed | PROJ-1, PROJ-3 | [Spec](PROJ-11-fileexplorer.md) |
| PROJ-12 | MD-Editor (voll, Obsidian-DNA) | P1 | Architected | PROJ-7 | [Spec](PROJ-12-md-editor.md) |
