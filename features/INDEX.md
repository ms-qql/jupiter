...
| PROJ-48 | Engine — OpenAI Codex CLI (Pro-Subscription) als Jupiter-Agent | P1 | Approved | PROJ-18, PROJ-1, PROJ-19 | [Spec](PROJ-48-engine-openai-codex-cli.md) |
...
| PROJ-50 | abc-Workflow für die Codex-Engine (portierte Skills + Phasen-Signal) | P1 | In Progress | PROJ-48, PROJ-9, PROJ-8 | [Spec](PROJ-50-abc-workflow-codex-engine.md) |
