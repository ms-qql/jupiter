...
| PROJ-35 | Session-Titel = eingegebener Projektname (Sidebar + Header) statt „jupiter" | P1 | In Review | PROJ-3, PROJ-9 | [Spec](PROJ-35-session-titel-projektname-anzeigen.md) |
| PROJ-36 | Eingabe-Buttons auf drei Reihen (Senden · Mikro+Büroklammer · Stop) | P2 | In Progress | PROJ-3, PROJ-20, PROJ-11, PROJ-29 | [Spec](PROJ-36-eingabe-buttons-drei-reihen.md) |
