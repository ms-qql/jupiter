...
| ID | Feature | Prio | Status | Abhängigkeiten | Spec |
|----|---------|------|--------|----------------|------|
| PROJ-9 | Smart Launcher (mitdenkender Session-Start) | P1 | Approved | PROJ-3, PROJ-1 | [Spec](PROJ-9-smart-launcher.md) |
...
| PROJ-12 | MD-Editor (voll, Obsidian-DNA) | P1 | Approved | PROJ-7 | [Spec](PROJ-12-md-editor.md) |
